export function inferLocalIntent(message) {
  ...
  if (
    /\b(contribute|contribution|help (the community|others)|give back|volunteer|become a mentor|mentor (the community|others|people|members|beginners)|support the community|share my experience)\b/.test(
      text,
    )
  ) {
    return "contributor";
